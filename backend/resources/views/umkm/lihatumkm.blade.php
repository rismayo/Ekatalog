                        ...
                        @foreach ($umkms as $index => $umkm)
                            <tr>
                                ...
                                <td>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form id="editDataForm" action="{{ route('produk.update', $produk->id_produk) }}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="mb-3 row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <textarea class="form-control" name="deskripsi_produk" id="deskripsi_produk" rows="3" required>{{ $produk->deskripsi_produk }}</textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="mb-3 row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                ...
                                                                @if ($produk->foto_produk)
                                                                    <img src="{{ asset('path/to/uploads/' . $produk->foto_produk) }}" alt="Foto Produk" class="mt-2" style="max-height: 100px;">
                                                                @endif
                                                            </div>
                                                        </div>
                                    ...
                                    @csrf
                                    @method('DELETE')
                                    <a href="{{ route('umkm.destroy', $umkm->id_umkm) }}" class="btn btn-danger btn-sm"
