        ...
        <div class="container-fluid fixed-top">
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="<?php echo e(url('/')); ?>" class="navbar-brand"><h1 class="text-primary display-6">Fruitables</h1></a>
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="<?php echo e(url('/shop')); ?>" class="nav-item nav-link active">Shop</a>
...
</html><?php /**PATH C:\xampp\htdocs\proyek1\resources\views/shop.blade.php ENDPATH**/ ?>